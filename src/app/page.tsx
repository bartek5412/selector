...
export default function HomePage() {
  ...
  return (
    <main className="flex h-screen w-screen flex-col lg:flex-row">
      {/* Panel kontrolny */}
      <div className="w-full lg:w-1/4 bg-white p-6 dark:bg-gray-900">
        <h1 className="text-2xl font-bold mb-6">Generator Liter 3D</h1>
        <Card className="grid grid-cols-1 gap-4 border-1 bg-orange-100 border-white p-4 rounded-md shadow-lg">
          <div>
          ...
          <div className="w-full max-w-sm">
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="rods-switch" className="text-base font-medium">
                  Konstrukcja
                </Label>
                <Switch
                  id="rods-switch"
              ...
              {/* Drugi przełącznik: Poświata */}
              <div className="flex items-center justify-between">
                <Label htmlFor="glow-switch" className="text-base font-medium">
                  Podświetlenie
                </Label>
                <Switch
                  id="glow-switch"
          ...
          <div>
            <Button onClick={handleUploadClick} className="w-full" disabled={true}>
              Wgraj własne SVG
            </Button>
            <Input
              type="file"
